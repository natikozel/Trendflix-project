...
### 1. [User Input Processing](https://github.com/natikozel/Trendflix-project/blob/production/src/algorithm/userInputToVector.js) (`userInputToVector.js`)
...
### 2. [Movie Content Vectorization](https://github.com/natikozel/Trendflix-project/blob/production/src/algorithm/movieReviewsToVector.js) (`movieReviewsToVector.js`)
...
### 3. [Recommendation Engine](https://github.com/natikozel/Trendflix-project/blob/production/src/algorithm/recommender.js) (`recommender.js`)
...
### 4. [Similarity Computation](https://github.com/natikozel/Trendflix-project/blob/production/src/algorithm/vectorComparison.js) (`vectorComparison.js`)
...
1. **[`src/algorithm/recommender.js`](https://github.com/natikozel/Trendflix-project/blob/production/src/algorithm/recommender.js)** - Main recommendation logic
2. **[`src/algorithm/userInputToVector.js`](https://github.com/natikozel/Trendflix-project/blob/production/src/algorithm/userInputToVector.js)** - NLP processing
3. **[`src/algorithm/movieReviewsToVector.js`](https://github.com/natikozel/Trendflix-project/blob/production/src/algorithm/movieReviewsToVector.js)** - TF-IDF implementation
4. **[`src/algorithm/vectorComparison.js`](https://github.com/natikozel/Trendflix-project/blob/production/src/algorithm/vectorComparison.js)** - Similarity algorithms
